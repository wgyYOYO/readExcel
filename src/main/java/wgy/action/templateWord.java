...
//        String filePath="f:/saveFile/temp/文本框0003.docx";
        String templatePath = "D:\\zltFile\\data\\template1.docx";
        readTextBoxContentUseXPath(templatePath);
        readTextBoxContentUseCursor(templatePath);
    }

    public static void readTextBoxContentUseXPath(String templatePath) throws Exception {
        ...
        saveDocument(xdoc, "d:/zltFile/word/sys_1_" + System.currentTimeMillis()
                + ".docx");
    }
    public static XmlCursor getXmlObjectByXPath(XmlObject xml, String nameSpace,
                                                String xpath) {
    ...
    public static void readTextBoxContentUseCursor(String filePath) throws Exception {
        ...
        cursor.dispose();
        saveDocument(xdoc, "d:/zltFile/word/sys_2_" + System.currentTimeMillis()
                + ".docx");
    }
